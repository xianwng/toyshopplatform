...
<head>
    ...
    <title>@yield('title', 'ToyShop Admin')</title>
    ...
    <style>
        ...
        .btn-primary-custom:hover {
            background: linear-gradient(135deg, #13855c, #0f6c4a);
            color: white;
            transform: translateY(-2px);
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse" id="sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.auctions.index') }}">
                                <i class="fas fa-gavel me-2"></i>
                                Auctions
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.trading.management') }}">
                            ...
                            <div class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                                    <div class="me-2">
                                        ...
                                        <small class="d-block text-muted">Store Admin</small>
                                    </div>
